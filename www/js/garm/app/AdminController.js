...
dojo.declare('garm.app.AdminController', null, {
    ...
    constructor : function(rootNode) {
        ...
        dojo.subscribe(garm.app.Constants.TOPIC_FORK_REMOVE,  this, this._showForkRemoving);
    },
    ...
    _showForkRemoving : function() {
        ...
        var askFork = dojo.hitch(this, function(forks) {
            garm.components.popup.PopUpFactory.getInstance().askOptions({
                ...
                options : forks,
                onOk : dojo.hitch(this, function(result) {
                    this._removeFork(result.value.option);
                })
            });
        });
    ...
    _removeFork : function(fork) {
        ...
        var deferred = dojo.xhrPost({
            ...
            load : dojo.hitch(this, function(result) {
                this._showSuccess('Version "' + fork + '" was removed');
            }),
            error : this._showError
        });
        this._showProgress(deferred, 'Remove Version');
    },
